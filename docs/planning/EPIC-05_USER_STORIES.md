...
> Planning and owner-review artifact only. No implementation acceptance is claimed in this document.
...
| G05-STORY-N | Next story | OPEN until evidence | Previous story DoD, automated gates, and owner/manual evidence decision satisfy its exit condition. |
...
| --- | --- | --- | --- | --- | --- | --- |
| New/returning/recovery launch | US-05-01 | [ ] | [ ] | [ ] | [ ] | [ ] |
