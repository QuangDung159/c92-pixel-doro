...
1. EPIC-05 formal tester vẫn `DEFERRED_TO_LATER_PHASE`; planning này không nâng cấp trạng thái đó.
...
- `US0605-KNOWN-01_NOTIFICATION_ICON_CROSS_PLATFORM_PARITY` — `CLOSED_OWNER_ACCEPTED` ngày
  2026-09-07 tại candidate `5d045058950ea373b1d438556062cf64073c6701`; explicit notification
  icon override đã được bỏ để dùng application icon.
